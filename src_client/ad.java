...
public class ad {
    ...
    public ad(int n2, int n3, int n4, int n5) {
        ...
        n4 = 0;
        while (n4 < 72) {
            this.LoginScreen.addElement(new aj(n2, n3, Math.abs(this.b.nextInt() % 8) + 3, n4 * 5, this.c[Math.abs(this.b.nextInt() % this.c.length)]));
            ++n4;
        }
    }
    ...
    public static InputStream LoginScreen(String string) {
