...
public final class mFont {
    ...
    private String N;
    private int[][] O;
    private static String P = " 0123456789+-*='_?.,<>/[]{}!@#$%^&*():LoginScreen\u00e1\u00e0\u1ea3\u00e3\u1ea1\u00e2\u1ea5\u1ea7\u1ea9\u1eab\u1ead\u0103\u1eaf\u1eb1\u1eb3\u1eb5\u1eb7bcd\u0111e\u00e9\u00e8\u1ebb\u1ebd\u1eb9\u00ea\u1ebf\u1ec1\u1ec3\u1ec5\u1ec7fghi\u00ed\u00ec\u1ec9\u0129\u1ecbjklmno\u00f3\u00f2\u1ecf\u00f5\u1ecd\u00f4\u1ed1\u1ed3\u1ed5\u1ed7\u1ed9\u01a1\u1edb\u1edd\u1edf\u1ee1\u1ee3pqrstu\u00fa\u00f9\u1ee7\u0169\u1ee5\u01b0\u1ee9\u1eeb\u1eed\u1eef\u1ef1vxy\u00fd\u1ef3\u1ef7\u1ef9\u1ef5zwA\u00c1\u00c0\u1ea2\u00c3\u1ea0\u0102\u1eb0\u1eae\u1eb2\u1eb4\u1eb6\u00c2\u1ea4\u1ea6\u1ea8\u1eaa\u1eacBCD\u0110E\u00c9\u00c8\u1eba\u1ebc\u1eb8\u00ca\u1ebe\u1ec0\u1ec2\u1ec4\u1ec6FGHI\u00cd\u00cc\u1ec8\u0128\u1ecaJKLMNO\u00d3\u00d2\u1ece\u00d5\u1ecc\u00d4\u1ed0\u1ed2\u1ed4\u1ed6\u1ed8\u01a0\u1eda\u1edc\u1ede\u1ee0\u1ee2PQRSTU\u00da\u00d9\u1ee6\u0168\u1ee4\u01af\u1ee8\u1eea\u1eec\u1eee\u1ef0VXY\u00dd\u1ef2\u1ef6\u1ef8\u1ef4ZW";
    public static mFont LoginScreen = new mFont(P, "/myfont/tahoma_7b_red.png", "/myfont/tahoma_7b", 0);
    ...
    public static mFont g = new mFont(P, "/myfont/tahoma_7b_green2.png", "/myfont/tahoma_7b", 0);
    public static mFont Item = new mFont(P, "/myfont/tahoma_7b_green.png", "/myfont/tahoma_7b", 0);
    ...
    public static mFont Res = new mFont(P, "/myfont/tahoma_7_blue1.png", "/myfont/tahoma_7", 0);
    ...
    public static mFont SessionReceiver = new mFont(P, "/myfont/tahoma_7_white.png", "/myfont/tahoma_7", 0);
    public static mFont MyHashtable = new mFont(P, "/myfont/tahoma_8b.png", "/myfont/tahoma_8b", -1);
    ...
    public static mFont G = g;
    public static mFont H = SessionReceiver;
    public static mFont I = Item;
    public static mFont J = Res;
    private String U;
    ...
    private mFont(String object, String string, String string2, int n2) {
        try {
            ...
            object = null;
            mFont di2 = this;
            this.M = Res.loadImage(di2.U);
            try {
                object = new DataInputStream(ad.LoginScreen(string2));
    ...
    public final int LoginScreen(String string) {
        int n2 = 0;
        int n3 = 0;
    ...
    public final void methodLoginScreen(mGraphics en2, String string, int n2, int n3, int n4) {
        int n5 = string.length();
        n4 = n4 == 0 ? n2 : (n4 == 1 ? n2 - this.LoginScreen(string) : n2 - (this.LoginScreen(string) >> 1));
        int n6 = 0;
        while (n6 < n5) {
            ...
            if (n2 >= 0) {
                en2.LoginScreen(this.M, this.O[n2][0], this.O[n2][1], this.O[n2][2], this.O[n2][3], 0, n4, n3, 20);
            }
    ...
    public final void methodLoginScreen(mGraphics en2, String string, int n2, int n3, int n4, mFont di2) {
        int n5 = string.length();
        n4 = n4 == 0 ? n2 : (n4 == 1 ? n2 - this.LoginScreen(string) : n2 - (this.LoginScreen(string) >> 1));
        int n6 = 0;
        while (n6 < n5) {
            ...
            if (n2 >= 0) {
                if (!GameCanvas.isLowGraphic) {
                    en2.LoginScreen(di2.M, this.O[n2][0], this.O[n2][1], this.O[n2][2], this.O[n2][3], 0, n4 + 1, n3, 20);
                    en2.LoginScreen(di2.M, this.O[n2][0], this.O[n2][1], this.O[n2][2], this.O[n2][3], 0, n4, n3 + 1, 20);
                }
                en2.LoginScreen(this.M, this.O[n2][0], this.O[n2][1], this.O[n2][2], this.O[n2][3], 0, n4, n3, 20);
            }
            n4 += this.O[n2][2] + this.K;
    ...
    public final String[] LoginScreen(String object, int n2) {
        int n3 = n2;
        String[] stringArray = object;
        object = this;
        MyVector el2 = new MyVector("vLine");
        String string = "";
        int n4 = 0;
        while (n4 < stringArray.length()) {
            if (stringArray.charAt(n4) == '\n' || stringArray.charAt(n4) == '\b') {
                ...
                if (((mFont)object).LoginScreen(string = String.valueOf(string) + stringArray.charAt(n4)) > n3) {
    ...
    public final void b(mGraphics en2, String string, int n2, int n3, int n4) {
        this.LoginScreen(en2, string, n2, n3, 2);
    }

    public final void b(mGraphics en2, String string, int n2, int n3, int n4, mFont di2) {
        this.LoginScreen(en2, string, n2, n3, n4, di2);
    }
}
