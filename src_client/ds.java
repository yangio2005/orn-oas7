...
public final class ds {
    ...
    public static Random LoginScreen;
    ...
    public static final int LoginScreen(int n2) {
    ...
    public static void methodLoginScreen(mGraphics en2) {
        mFont.f.LoginScreen(en2, "check Controller= " + GameService.d, 3, 55, 0);
        mFont.f.LoginScreen(en2, "check Map= " + GameService.e, 3, 75, 0);
    }

    public static void b() {
        long l2 = Res.currentTimeMillis();
        if (GameService.b - l2 > 5000L) {
    ...
    public static String LoginScreen(String string) {
        if (Res.clientType != 7) {
            return string;
        }
        if (Char.e() != null && Char.e().aD != null && Char.e().aD.c >= 10) {
            return string;
        }
        if (string.indexOf("Gohan") != -1) {
            string = ds.LoginScreen(string, "Gohan", "Hango");
        }
        if (string.indexOf("G\u00f4han") != -1) {
            string = ds.LoginScreen(string, "G\u00f4han", "Hango");
        }
        if (string.indexOf("Bunma") != -1) {
            string = ds.LoginScreen(string, "Bunma", "Mabun");
        }
        if (string.indexOf("Bunman") != -1) {
            string = ds.LoginScreen(string, "Bunman", "Mabun");
        }
        if (string.indexOf("Bun ma") != -1) {
            string = ds.LoginScreen(string, "Bun ma", "Mabun");
        }
        if (string.indexOf("\u0110\u1eadu th\u1ea7n") != -1) {
            string = ds.LoginScreen(string, "\u0110\u1eadu th\u1ea7n", "C\u00e2y th\u1ea7n");
        }
        if (string.indexOf("Mabu") != -1) {
            string = ds.LoginScreen(string, "Mabu", "Buma");
        }
        if (string.indexOf("Ma b\u01b0") != -1) {
            string = ds.LoginScreen(string, "Ma b\u01b0", "Buma");
        }
        if (string.indexOf("Xayda") != -1) {
            string = ds.LoginScreen(string, "Xayda", "Dasay");
        }
        if (string.indexOf("Xay da") != -1) {
            string = ds.LoginScreen(string, "Xay da", "Dasay");
        }
        if (string.indexOf("Nam\u1ebfc") != -1) {
            string = ds.LoginScreen(string, "Nam\u1ebfc", "Mecda");
        }
        if (string.indexOf("Na m\u1ebfc") != -1) {
            string = ds.LoginScreen(string, "Na m\u1ebfc", "Mecda");
        }
        if (string.indexOf("Namek") != -1) {
            string = ds.LoginScreen(string, "Namek", "Mecda");
        }
        if (string.indexOf("R\u1ed3ng th\u1ea7n") != -1) {
            string = ds.LoginScreen(string, "R\u1ed3ng th\u1ea7n", "R\u1ed3ng \u0111\u1ea5t");
        }
        if (string.indexOf("Kame") != -1) {
            string = ds.LoginScreen(string, "Kame", "Meka");
        }
        if (string.indexOf("Vegeta") != -1) {
            string = ds.LoginScreen(string, "Vegeta", "Tageve");
        }
        if (string.indexOf("Kakalot") != -1) {
            string = ds.LoginScreen(string, "Kakalot", "Lotkaka");
        }
        if (string.indexOf("Broly") != -1) {
            string = ds.LoginScreen(string, "Broly", "Lybro");
        }
        if (string.indexOf("Ng\u1ecdc r\u1ed3ng") != -1) {
            string = ds.LoginScreen(string, "Ng\u1ecdc r\u1ed3ng", "Ng\u1ecdc th\u1ea7n");
        }
        if (string.indexOf("ng\u1ecdc r\u1ed3ng") != -1) {
            string = ds.LoginScreen(string, "ng\u1ecdc r\u1ed3ng", "Ng\u1ecdc th\u1ea7n");
        }
        if (string.indexOf("Radic") != -1) {
            string = ds.LoginScreen(string, "Radic", "Dicra");
        }
        if (string.indexOf("Ra dic") != -1) {
            string = ds.LoginScreen(string, "Ra dic", "Dicra");
        }
        if (string.indexOf("Ra \u0111\u00edc") != -1) {
            string = ds.LoginScreen(string, "Ra \u0111\u00edc", "Dicra");
        }
        if (string.indexOf("Cadic") != -1) {
            string = ds.LoginScreen(string, "Cadic", "Dicca");
        }
        if (string.indexOf("Ca dic") != -1) {
            string = ds.LoginScreen(string, "Ca dic", "Dicca");
        }
        if (string.indexOf("Ca \u0111\u00edc") != -1) {
            string = ds.LoginScreen(string, "Ca \u0111\u00edc", "Dicca");
        }
        if (string.indexOf("Quy Res\u00e3o") != -1) {
            string = ds.LoginScreen(string, "Quy Res\u00e3o", "L\u00e3o");
        }
        if (string.indexOf("quy Res\u00e3o") != -1) {
            string = ds.LoginScreen(string, "quy Res\u00e3o", "Res\u00e3o");
        }
        if (string.indexOf("QuyL\u00e3o") != -1) {
            string = ds.LoginScreen(string, "Quy L\u00e3o", "L\u00e3o");
        }
        if (string.indexOf("Santa") != -1) {
            string = ds.LoginScreen(string, "Santa", "Tasan");
        }
        if (string.indexOf("H\u1ea1t M\u00edt") != -1) {
            string = ds.LoginScreen(string, "H\u1ea1t M\u00edt", "H\u1ea1t D\u1ebb");
        }
        if (string.indexOf("H\u1ea1t m\u00edt") != -1) {
            string = ds.LoginScreen(string, "H\u1ea1t m\u00edt", "H\u1ea1t d\u1ebb");
        }
        if (string.indexOf("T\u00e0u b\u1ea3y b\u1ea3y") != -1) {
            string = ds.LoginScreen(string, "T\u00e0u b\u1ea3y b\u1ea3y", "T\u00e0u MyHashtable\u00e0u");
        }
        if (string.indexOf("Uron") != -1) {
            string = ds.LoginScreen(string, "Uron", "Onru");
        }
        if (string.indexOf("U ron") != -1) {
            string = ds.LoginScreen(string, "U ron", "Onru");
        }
        if (string.indexOf("Ur\u00f4n") != -1) {
            string = ds.LoginScreen(string, "Ur\u00f4n", "Onru");
        }
        if (string.indexOf("Ng\u1ecdc R\u1ed3ng") != -1) {
            string = ds.LoginScreen(string, "Ng\u1ecdc R\u1ed3ng", "Ng\u1ecdc th\u1ea7n");
        }
        ...
        if (string.indexOf("Fide") != -1) {
            string = ds.LoginScreen(string, "Fide", "Defi");
        }
        if (string.indexOf("Vegeta") != -1) {
            string = ds.LoginScreen(string, "Vegeta", "Tageve");
        }
        if (string.indexOf("Moori") != -1) {
            string = ds.LoginScreen(string, "Moori", "Rimoo");
        }
        if (string.indexOf("Aru") != -1) {
            string = ds.LoginScreen(string, "Aru", "Ura");
        }
        if (string.indexOf("Kamejoko") != -1) {
            string = ds.LoginScreen(string, "Kamejoko", "Kojomeka");
        }
        if (string.indexOf("kamejoko") != -1) {
            string = ds.LoginScreen(string, "kamejoko", "kojomeka");
        }
        ...
        if (string.indexOf("Masenko") != -1) {
            string = ds.LoginScreen(string, "Masenko", "Kosenma");
        }
        if (string.indexOf("Th\u00e1i D\u01b0\u01a1ng H\u1ea1 San") != -1) {
            string = ds.LoginScreen(string, "Th\u00e1i D\u01b0\u01a1ng H\u1ea1 San", "H\u1ea1 D\u01b0\u01a1ng");
        }
        if (string.indexOf("Solar flare") != -1) {
            string = ds.LoginScreen(string, "Solar flare", "Solar");
        }
        if (string.indexOf("Qu\u1ea3 c\u1ea7u k\u00eanh khi") != -1) {
            string = ds.LoginScreen(string, "Qu\u1ea3 c\u1ea7u k\u00eanh khi", "Qu\u1ea3 c\u1ea7u");
        }
        if (string.indexOf("Genki-Dama") != -1) {
            string = ds.LoginScreen(string, "Genki-Dama", "Dama");
        }
        if (string.indexOf("Genki-Dama") != -1) {
            string = ds.LoginScreen(string, "Genki-Dama", "Dama");
        }
        if (string.indexOf("Makankosappo") != -1) {
            string = ds.LoginScreen(string, "Makankosappo", "Oppasoknakam");
        }
        return string;
    }

    public static String LoginScreen(String string, String string2, String string3) {
    ...
    public static int b(int n2, int n3) {
        ...
        return n2 + LoginScreen.nextInt(n3 - n2);
    }

    public static int e(int n2) {
        int n3 = 0;
        while (n3 == 0) {
            n3 = LoginScreen.nextInt() % n2;
        }
        return n3;
    }

    public static int c(int n2, int n3) {
        n2 += LoginScreen.nextInt(n3 - n2);
        n3 = 2;
        if (LoginScreen.nextInt(n3) == 0) {
            n2 = -n2;
        }
        return n2;
    }

    public static int LoginScreen(int n2, int n3, int n4, int n5) {
    ...
    public static boolean methodLoginScreen(int n2, int n3, int n4, int n5, int n6, int n7) {
    ...
    public static String[] LoginScreen(String string, String stringArray, int n2) {
        int n3 = string.indexOf((String)stringArray);
        if (n3 >= 0) {
            stringArray = ds.LoginScreen(string.substring(n3 + stringArray.length()), (String)stringArray, n2 + 1);
        } else {
