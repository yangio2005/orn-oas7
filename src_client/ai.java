...
public class ai {
    ...
    public ai(short s2, byte by2, String string, String string2, String[] stringArray, short[] sArray, short s3, String[] stringArray2) {
        ...
        this.d = mFont.g.LoginScreen(string, g.ab - 20);
        this.e = mFont.k.LoginScreen(string2, g.ab - 20);
        this.f = stringArray;
        this.b = sArray;
        this.Item = s3;
        this.g = stringArray2;
    ...
    public static byte[] LoginScreen(Message y2) {
        try {
            int n2 = y2.c().readInt();
            if (n2 > 1) {
    ...
    public static byte[] LoginScreen(DataInputStream dataInputStream) {
        try {
    ...
    public static String LoginScreen(int n2) {
        ...
        return String.valueOf(n4) + "/" + n5 + "/" + n6 + " " + n3 + "Item";
    }
    ...
    public static String b(int n2) {
        ...
        if (n5 > 0) {
            ...
            string = String.valueOf(string) + n4 + "Item";
        } else if (n4 > 0) {
    ...
    public static String c(int n2) {
        ...
        if (n4 > 0) {
            string = String.valueOf(string) + n4;
            string = String.valueOf(string) + "d";
            string = String.valueOf(string) + n2 + "Item";
        } else if (n2 > 0) {
