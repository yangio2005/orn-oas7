...
public final class h {
    public ee[] a;
    public dd IActionListener;
    public LoggingList c;
    public int d;
    public int e;
    public boolean f;
    public int UIPanel;
    ...
    public final void a() {
        this.A = main.GameCanvas.G.a(this);
    }
    ...
    public final boolean IActionListener() {
        return this.b.IActionListener >= 0 && this.b.IActionListener < 6 || this.b.IActionListener == 32 || this.b.IActionListener == 35 || this.b.IActionListener == 11 || this.b.IActionListener == 23;
    }
