...
implements bq {
    ...
    public d(int n2, short s2, short s3, int n3, long l2, long l3) {
        ...
        nArray6[22] = 1;
        nArray6[23] = 1;
        this.RMSManager = new int[]{4, 4, 4, 5, 5, 5, 6, 6, 6, 6, 6, 6, 3, 3, 3, 2, 2, 2, 1, 1, 1};
        this.GameStrings = new int[]{6, 6, 6, 3, 3, 3, 2, 2, 2, 1, 1, 1};
        ...
        ae = null;
        ae = new ck();
        String string = "/x" + MGraphics.IActionListener + "/effectdata/" + 109 + "/data";
        try {
            ae.IActionListener(string);
            d.ae.a = ResourceUtil.c("/effectdata/109/img.png");
        }
        catch (Exception exception) {
            GameService.a().h(d2.C);
        }
        d2.v = d.ae.f;
        d2.w = d.ae.UIPanel;
        this.GameScreen = 2;
    ...
    public final void c() {
        ...
        d2.GameWorld = d2.m;
        d2.ai = 0;
        if (d2.ag > 0 && !bv.a(d2.GameWorld, d2.ag, 2)) {
            if (bv.a(d2.GameWorld / by2, d2.ag / by2) == 0) {
                d2.ah = true;
            } else if (bv.a(d2.GameWorld / by2, d2.ag / by2) != 0 && !bv.a(d2.GameWorld, d2.ag, 2)) {
                d2.GameWorld = d2.m;
                d2.ag = d2.n;
                d2.ah = false;
            }
            while (d2.ah && d2.ai < 10) {
                ++d2.ai;
                d2.ag += 24;
                if (!bv.a(d2.GameWorld, d2.ag, 2)) continue;
                if (d2.ag % 24 == 0) break;
                d2.ag -= d2.ag % 24;
                break;
            }
        ...
        switch (this.GameScreen) {
            case 2: {
                d2 = this;
                d2.a(d2.as);
                if (d2.m != d2.a || d2.n != d2.IActionListener) {
                    d2.m += (d2.a - d2.m) / 4;
                    d2.n += (d2.IActionListener - d2.n) / 4;
                }
                return;
            }
            case 4: {
            ...
            case 1: {
                ...
                if (main.GameCanvas.w % 5 == 0) {
                    ...
                    d4 = d6;
                    d4 = d2;
                    at.a(167, MathUtil.IActionListener(d2.m - 50 / 2, d2.m + 50 / 2), MathUtil.IActionListener(d5.n - 50 + 40 / 2, d6.n - 50 + 40), 1);
                }
                if (d2.m == d2.a && d2.n == d2.IActionListener) break;
                d2.m += (d2.a - d2.m) / 4;
                d2.n += (d2.IActionListener - d2.n) / 4;
            }
        }
