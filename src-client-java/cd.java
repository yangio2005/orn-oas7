...
implements IActionListener {
    ...
    static {
        ...
        F = 11;
        G = ResourceUtil.IActionListener("/mainImage/myTexture2der.png");
        I = ResourceUtil.IActionListener("/mainImage/myTexture2dtf.png");
    ...
    public final void a() {
        ...
        textBox.addCommand(new Command(GameStrings.bs, 4, 0));
        textBox.addCommand(new Command(GameStrings.bv, 3, 0));
    ...
    public cd() {
        cd cd2 = this;
        o = mFont.t.a() + 1;
        cd2.j = new Command(GameStrings.bk, cd2, 1000, null);
        D = 0;
        if (RMSManager.d("qwerty") == 1) {
            UIPanel = true;
        }
    }
    ...
    public final boolean a(int n2) {
        ...
        if (n2 >= 65 && n2 <= 122 && !UIPanel) {
            UIPanel = true;
            D = 0;
            RMSManager.a("qwerty", 1);
        }
        if (UIPanel) {
            if (n2 == 45) {
    ...
    public final void a(MGraphics en2) {
        ...
        int n2 = this.b + (this.d - mFont.t.a()) / 2;
        ...
        if (bl3) {
            ((MGraphics)object).a(I, 0, 81, 29, 27, 0, n7, n6, 0);
            ((MGraphics)object).a(I, 0, 135, 29, 27, 0, n7 + n5 - 29, n6, 0);
            ((MGraphics)object).a(I, 0, 108, 29, 27, 0, n7 + n5 - 58, n6, 0);
            int n8 = 0;
            while (n8 < (n5 - 58) / 29) {
                ((MGraphics)object).a(I, 0, 108, 29, 27, 0, n7 + 29 + n8 * 29, n6, 0);
                ++n8;
            }
        } else {
            ((MGraphics)object).a(I, 0, 0, 29, 27, 0, n7, n6, 0);
            ((MGraphics)object).a(I, 0, 54, 29, 27, 0, n7 + n5 - 29, n6, 0);
            ((MGraphics)object).a(I, 0, 27, 29, 27, 0, n7 + n5 - 58, n6, 0);
            int n9 = 0;
            while (n9 < (n5 - 58) / 29) {
                ((MGraphics)object).a(I, 0, 27, 29, 27, 0, n7 + 29 + n9 * 29, n6, 0);
                ++n9;
            }
        }
        ((MGraphics)object).e(n7 + 3, n6 + 1, n5 - 4, n4);
        if (string2 != null && !string2.equals("")) {
            mFont.t.a((MGraphics)object, string2, n3, n2, 0);
        } else if (string != null) {
            if (bl3) {
                mFont.i.a((MGraphics)object, string, n3, n2 + 2, 0);
            } else {
                mFont.j.a((MGraphics)object, string, n3, n2 + 2, 0);
            }
        }
        en2.a(0);
        object = this;
        if (((cd)object).e && this.k) {
            if (this.z == 0 && (this.B > 0 || this.v / 5 % 2 == 0)) {
                en2.a(7999781);
                en2.d(7 + this.x + this.a + mFont.t.a(this.t.substring(0, this.u)) - 1, this.b + (this.d - o) / 2 + 1, 1, o);
            }
            main.GameCanvas.a(en2);
            if (this.r != null && this.r.length() > 0 && main.GameCanvas.e && bl2) {
    ...
    public final void c() {
        ...
        if (main.GameCanvas.m) {
            cd cd2 = this;
            if (main.GameCanvas.a(cd2.a + cd2.c - 20, cd2.IActionListener, 40, cd2.d)) {
                cd cd3 = cd2;
                cd2.r = "";
                cd3.u = 0;
                cd3.e();
            ...
            if (main.GameCanvas.a(cd2.a, cd2.IActionListener, cd2.c, cd2.d)) {
                cd2.a();
                return;
            }
            cd2.e = false;
